...
document.write(
  `<h3>El primer, tercer y ultimo elementos son:</h3><p>${ciudades[0]}, ${
    ciudades[2]
  } y ${ciudades[ciudades.length - 1]} </p>`
);
...
document.write(
  `<h3>El elemento de la segunda posición es:</h3><p>${segPos}</p>`
);

ciudades[1] = "Barcelona";
document.write(
  `<h3>Se reemplaza el segundo elemento con Barcelona:</h3><p>${ciudades}</p>`
);
